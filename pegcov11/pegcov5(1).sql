...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2021 at 09:56 AM
...
(31, 3, 'Martin Rabun', '56566', '55663', 'Manto', 'Laki-laki', 'Kakak/Adik', '1994-11-06', '432434', 'Non Kemenkes', '', '456758765', '2021-02-07', '2021-02-08', 'Isman', 'Dalam Proses', 'fdfsdfses\r\n                    ', '2021-02-09', '2021-02-09'),
(39, 18, 'Kara', '678', '876', 'vhfdjvk', 'Laki-laki', 'Suami/Istri', '2020-01-08', '731987398', 'Non Kemenkes', '', '33213', '0000-00-00', '0000-00-00', 'Isman', 'Dalam Proses', ' \r\n                    ', '2021-02-09', '2021-02-09'),
(40, 18, 'Kara', '678', '876', 'vhfdjvk', 'Laki-laki', 'Suami/Istri', '2020-01-08', '731987398', 'Non Kemenkes', '', '33213', '0000-00-00', '0000-00-00', 'Isman', 'Dalam Proses', ' \r\n                    ', '2021-02-09', '2021-02-09'),
(43, 1, 'Januar Salasanto', '1212', '1122', 'gg', 'Laki-laki', 'Suami/Istri', '2020-01-08', '34', 'Kemenkes', '', '', '0000-00-00', '0000-00-00', 'Isman', 'Dalam Proses', ' \r\n                    ', '2021-02-09', '2021-02-09');
...
(34, 1, 'Januar Salasanto', 'Laki-laki', '1990-01-04', '1212', '1122', 'PNS', 'Biro', '', 'Umum', '2021-03-04', '2021-03-08', '', '', '', ' xxx\r\n                    ', '2021-01-20', '2021-01-25'),
(35, 2, 'Febrianti Mingguini', 'Perempuan', '1991-01-29', '3434', '3344', 'PNS', 'Direktorat', '', 'TU', '2020-12-01', '0000-00-00', '', '', '', 'hgfhgff\r\n                    ', '2020-12-20', '2021-12-20'),
(36, 2, 'Febrianti Mingguini', 'Perempuan', '1991-01-29', '3434', '3344', 'PNS', 'Direktorat', '', 'TU', '2020-12-01', '0000-00-00', '', '', '', ' asdfghjk\r\n                    ', '2021-01-20', '2021-01-20'),
...
(39, 3, 'Martin Rabun', 'Laki-laki', '1992-01-17', '56566', '55663', 'PNS', 'Kesehatan', '', 'Masyarakat', '2021-01-03', '0000-00-00', 'Isman', 'Dalam Proses', '', 'jjokjlhkghk\r\n                    ', '2021-01-20', '2021-02-09'),
(40, 5, 'Apriliatiwati Sajadi', 'Perempuan', '1988-02-22', '70002', '70011', 'PNS', 'Teknik', '', 'Informatika', '2021-01-04', '0000-00-00', '', '', '', ' yigm hmj\r\n                    ', '2021-01-20', '2021-01-20'),
(41, 5, 'Apriliatiwati Sajadi', 'Perempuan', '1988-02-22', '70002', '70011', 'PNS', 'Teknik', '', 'Informatika', '2021-01-04', '0000-00-00', '', '', '', ' xxx\r\n                    ', '2021-01-20', '2021-01-26'),
(42, 6, 'Maya Duniyah', 'Perempuan', '1986-07-24', '90902', '99004', 'PNS', 'Jaringan', '', 'Kabel', '2021-01-05', '0000-00-00', '', '', '', 'poiughfghg \r\n                    ', '2020-12-20', '2021-01-20'),
(43, 6, 'Maya Duniyah', 'Perempuan', '1986-07-24', '90902', '99004', 'PNS', 'Jaringan', '', 'Kabel', '2021-01-05', '0000-00-00', '', '', '', 'jkouiygjy\r\n                    ', '2021-01-20', '2021-01-20'),
(44, 7, 'Juna Haliday', 'Laki-laki', '1985-08-15', '91912', '99116', 'PNS', 'Bagian', '', 'Logistik', '2021-01-06', '0000-00-00', '', '', '', ' jghhjbfh\r\n                    ', '2021-01-20', '2021-01-20'),
(45, 7, 'Juna Haliday', 'Laki-laki', '1985-08-15', '91912', '99116', 'PNS', 'Bagian', '', 'Logistik', '2021-01-06', '0000-00-00', '', '', '', ' iuyyjgfj\r\n                    ', '2021-01-20', '2021-01-26'),
(46, 1, 'Januar Salasanto', 'Laki-laki', '1990-01-04', '1212', '1122', 'PNS', 'Biro', '', 'Umum', '2021-01-25', '2021-01-25', '', '', '', '2525525252525\r\n                    ', '2021-01-25', '2021-01-25'),
(47, 1, 'Januar Salasanto', 'Laki-laki', '1990-01-04', '1212', '1122', 'PNS', 'Biro', '', 'Umum', '2021-01-26', '2021-01-26', '', '', '', 'xxxx\r\n                    ', '2021-01-25', '2021-01-26'),
(48, 10, 'Septiono Endang', 'Laki-laki', '1978-05-11', '45732', '44664', 'Non PNS', 'Biro', '', 'SLGK', '2021-01-01', '2021-01-08', '', '', '', 'gfhghgfhft \r\n                    ', '2021-01-26', '2021-01-26'),
(49, 12, 'Novirianti Khamisiah', 'Perempuan', '1978-09-15', '45678', '56844', 'Non PNS', 'Pusdatin', '', 'PSI', '2021-01-01', '2021-01-12', '', '', '', 'dsfdsfs\r\n                    ', '2021-01-26', '2021-01-26'),
(50, 11, 'Okta Gon', 'Laki-laki', '1988-01-05', '64457', '23496', 'PNS', 'Biro', '', 'CPU', '2021-01-16', '2021-01-18', '', '', '', ' Surat menyusul\r\n                    ', '2021-01-27', '2021-01-27'),
(51, 12, 'Novirianti Khamisiah', 'Perempuan', '1978-09-15', '45678', '56844', 'Non PNS', 'Pusdatin', '', 'PSI', '2021-01-21', '2021-01-25', '', '', '', 'qewew \r\n                    ', '2021-01-27', '2021-01-27'),
(52, 5, 'Apriliatiwati Sajadi', 'Perempuan', '1988-02-22', '70002', '70011', 'PNS', 'Teknik', '', 'Informatika', '2021-01-27', '2021-01-27', '', '', '', ' \r\n                    ', '2021-01-27', '2021-01-27'),
(53, 1, 'Januar Salasanto', 'Laki-laki', '1990-01-04', '1212', '1122', 'PNS', 'Biro', '', 'Umum', '2021-01-27', '2021-01-28', '', '', '', 'jkhjkghgbjm\r\n                    ', '2021-01-29', '2021-01-29'),
...
(55, 1, 'Januar Salasanto', 'Laki-laki', '1990-01-04', '1212', '1122', 'PNS', 'Biro', '', 'Umum', '2021-01-27', '2021-01-28', '', '', '', 'xxxx            ', '2021-01-29', '2021-01-29'),
(56, 3, 'Martin Rabun', 'Laki-laki', '1992-01-17', '56566', '55663', 'PNS', 'Kesehatan', '', 'Masyarakat', '2021-02-05', '2021-02-06', 'Isman', 'Dalam Proses', '', 'gggggggg', '2021-01-29', '2021-02-09'),
(61, 6, 'Maya Duniyah', 'Perempuan', '1986-07-24', '90902', '99004', 'PNS', 'Jaringan', '', 'Kabel', '2021-01-26', '2021-01-28', '', '', '', ' \r\n                    ', '2021-01-29', '2021-01-29'),
(62, 6, 'Maya Duniyah', 'Perempuan', '1986-07-24', '90902', '99004', 'PNS', 'Jaringan', '', 'Kabel', '2021-01-27', '0001-01-01', '', '', '', 'abcdefg          ', '2021-01-29', '2021-01-29'),
(63, 18, 'Kara', 'Laki-laki', '1996-06-06', '678', '876', 'PNS', '700100000000', '700108000000', 'AAA', '2021-02-03', '2021-02-04', 'Isman', 'Dalam Proses', '', 'test\r\n                    ', '2021-02-05', '2021-02-05'),
(64, 18, 'Kara', 'Laki-laki', '1996-06-06', '678', '876', 'PNS', '700100000000', '700108000000', 'AAA', '2021-02-01', '2021-02-02', 'Isman', 'Dalam Proses', '', 'dafsdefes\r\n                    ', '2021-02-05', '2021-02-05'),
(65, 18, 'Kara', 'Laki-laki', '1996-06-06', '678', '876', 'PNS', '700100000000', '700108000000', 'AAA', '2021-01-31', '2021-02-01', 'Isman', 'Dalam Proses', '', 'sdsfdesfw           ', '2021-02-05', '2021-02-05'),
(72, 14, 'jen', 'Perempuan', '1992-01-01', '2', '2', 'PNS', '4', '4', '4', '0000-00-00', '0000-00-00', 'Isman', 'Sembuh', '', ' \r\n                    ', '2021-02-09', '2021-02-09'),
(73, 1, 'Januar Salasanto', 'Laki-laki', '1990-01-04', '1212', '1122', 'PNS', '410000001', '', 'Umum', '0000-00-00', '0000-00-00', 'Isman', 'Dalam Proses', '', ' \r\n                    ', '2021-02-09', '2021-02-09');
...
(1, 'Januar Salasanto', 'Laki-laki', '1990-01-04', '1212', '1122', 'PNS', '410000001', '', 'Umum'),
(2, 'Febrianti Mingguini', 'Perempuan', '1991-01-29', '3434', '3344', 'PNS', '410000001', '', 'TU'),
(3, 'Martin Rabun', 'Laki-laki', '1992-01-17', '56566', '55663', 'PNS', '410000001', '', 'Masyarakat'),
...
(13, 'Han', 'Laki-laki', '1991-01-01', '1', '1', 'PNS', '1', '1', '1'),
(14, 'jen', 'Perempuan', '1992-01-01', '2', '2', 'PNS', '4', '4', '4'),
(15, 'jonatan', 'Laki-laki', '2020-01-04', '12129', '11229', 'PNS', '700100000000', '700101000000', 'AAA'),
(16, 'Era', 'Laki-laki', '2000-01-10', '789', '987', 'PNS', '700100000000', '700108000000', 'AAA'),
(18, 'Kara', 'Laki-laki', '1996-06-06', '678', '876', 'PNS', '700100000000', '700108000000', 'AAA'),
(19, 'Dora', 'Perempuan', '1991-01-03', '2340', '2340', 'PNS', '700100000000', '700108000000', 'AAA'),
(20, 'Jun', 'Laki-laki', '2020-01-06', '234', '4324', 'PNS', '700100000000', '700108000000', 'AAA');
...
(27, '2020', '12', '', '2', 1, 3, 0, 0, 3),
(28, '2021', '01', '', '6', 3, 6, 3, 0, 9),
(29, '2021', '02', '', '4', 0, 4, 0, 0, 4);
...
(2, 'Sumit Sodoku', 'sumut@yahoo.com', '085476540987', 'Admin', 'Inspektur Jenderal', '', '', 'user', 'ee11cbb19052e40b07aac0ca060c23ee', '3333', '4444'),
...
(7, 'Kukira Takada R', 'takadatr@gmail.com', '087564758999', 'Super', '700100000000', '700101000000', 'CCC', 'admin', '21232f297a57a5a743894a0e4a801fc3', '999', '888'),
(8, 'r', 'r@r', '8', 'Super', '', '', '', 'r', '4b43b0aee35624cd95b910189b3dc231', '2', '1'),
(9, 'q', 'q@q', '1', 'Super', '410000001', '', '', 'q', '7694f4a66316e53c8cdd9d9954bd611d', '4', '3'),
(11, 'Andes', 'a@a', '23145', 'Admin', '700100000000', '700108000000', 'BBB', 'a', '0cc175b9c0f1b6a831c399e269772661', '5613433', '432423');
...
--
ALTER TABLE `tb_kel`
  MODIFY `kel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
-- AUTO_INCREMENT for table `tb_kon`
--
ALTER TABLE `tb_kon`
  MODIFY `kon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
-- AUTO_INCREMENT for table `tb_peg`
--
ALTER TABLE `tb_peg`
  MODIFY `peg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `tb_rekkel`
--
ALTER TABLE `tb_rekkel`
  MODIFY `rekkel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `tb_rekkon`
--
ALTER TABLE `tb_rekkon`
  MODIFY `rekkon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
--
