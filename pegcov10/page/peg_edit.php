              ...
              <form method="POST">
                ...
                <div class="form-group">
                  ...
                  <option></option>
                    ...
                    ?>
                    <option class="form-control" value="<?php echo $data_org['org_nama']; ?>"
                        <?php if ($data['peg_org']==$data_org['org_nama']) { echo "Selected";} ?>
                    >
                ...
                <div class="form-group">
                  ...
                  <option></option>
                      ...
                      ?>
                    <option class="form-control" value="<?php echo $data_orgsat['orgsat_nama']; ?>"
                        <?php if ($data['peg_orgsat']==$data_orgsat['orgsat_nama']) { echo "Selected";} ?>
                    >
