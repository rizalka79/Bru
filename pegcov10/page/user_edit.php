            ...
            <form method="POST">
              ...
              <div class="form-group">
                  ...
                  <select name="akses" class="form-control" required="required">
                    <option <?php if ($data['user_akses']=="Umum")  { echo "selected"; } ?> class="form-control">Umum</option>
                    <option <?php if ($data['user_akses']=="Admin") { echo "selected"; } ?> class="form-control">Admin</option>
                    <option <?php if ($data['user_akses']=="Super") { echo "selected"; } ?> class="form-control">Super</option>
                  </select>
              </div>
              ...
              <div class="form-group">
                  ...
                  value="<?php echo $data['user_nip']; ?>" type="text" required="required" />
              </div>
              <div class="form-group">
                  <label>NIP</label><font color="red"> *</font>
                  <input class="form-control" name="nik" 
                  value="<?php echo $data['user_nik']; ?>" type="text" required="required" />
              </div>
