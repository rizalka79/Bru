	    ...
	    <h3><span class="fa fa-file-o"></span>
		    ...
		    <?php
			    if ($user_akses=="Super") {
			  		...
			  		$qjumlah 	= mysqli_query($koneksi,"SELECT DISTINCT kel_peg_nik, kel_nik FROM tb_kel WHERE kel_peg_orgsat='$user_orgsat'");
		      		$jumlah 	= mysqli_num_rows($qjumlah);
			    }
		    ?>
          	...
          	<table id="example1" class="table table-bordered table-striped">
			    ...
			    if ($user_akses=="Super") {
					    ...
					    $sql = $koneksi->query("SELECT DISTINCT 
					    	...
					    	kel_stapeg, 
					    	kel_nip 
					    	FROM tb_kel WHERE kel_peg_orgsat='$user_orgsat'");
