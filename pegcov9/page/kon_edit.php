<?php
  ...
  $qpeg_nik = $data['kon_peg_nik'];
  $qpeg_nama = $data['kon_peg_nama'];
...
<!--
                <div class="form-group" >
                  ...
                  <select  class="form-control myselect" name="kon_peg_nik" required="required" style="width:1210px;">
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////////   -->
                  ...
                  <a class="btn btn-sm btn-danger" href="?menu=zpeg_data2&zpeg_nik=<?php echo $qpeg_nik; ?>">Batal</a>
              </form>
              <?php 
...
//////////////////////////////////////////////////////////   
              ...
              ?>
                <script type="text/javascript">
                  ...
                  document.location.href="?menu=zpeg_data2&zpeg_nik=<?php echo $qpeg_nik; ?>";
                </script>
              <?php } ?>
            </div>
          </div>
