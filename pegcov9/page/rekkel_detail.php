...
<body>
    ...
    <div class="col-xs-12 col-md-12">
      <h3><span class="fa fa-bar-chart"></span>
        ...
        <a href="?menu=rekkel_detail&rekkel_id=<?php echo $data['rekkel_id']; ?>" class="btn btn-sm btn-primary"><span class="fa fa-refresh"></a>
    </h3>
    </div>
  </div>
<!-- ////////////////////////////////////////////// -->
        ...
        <div class="box-body">
          ...
          ?>
            <tr>
                ...
                <td> <?php echo $data['kel_stapeg']; ?>
                  <br>
                <?php echo "(".$data['kel_unitkerja'].")"    ; ?></td>
