        ...
        <div class="box-body">
          	<table id="example1" class="table table-bordered table-striped">
	            ...
	            <tbody>
					<?php
					    $no = 1;
					    $sql = $koneksi->query("SELECT DISTINCT kel_nama, kel_jk, kel_hubungan, kel_tgllahir, kel_nik, kel_stapeg, kel_unitkerja, kel_nip FROM tb_kel WHERE kel_peg_nik='$peg_nik' ");
